...
echo "import * as nip46 from 'nostr-tools/nip46'; window.BunkerSigner = nip46.BunkerSigner; window.parseBunkerInput = nip46.parseBunkerInput; window.parseNostrConnectURI = nip46.parseNostrConnectURI; window.createNostrConnectURI = nip46.createNostrConnectURI; window.toBunkerURL = nip46.toBunkerURL; window.createAccount = nip46.createAccount; window.fetchBunkerProviders = nip46.fetchBunkerProviders;" > temp.js
npx esbuild temp.js --bundle --format=iife --outfile=nip46.js
```
paste here 
 */
...
(() => {
  ...
  window.parseNostrConnectURI = parseNostrConnectURI;
  window.createNostrConnectURI = createNostrConnectURI;
  window.toBunkerURL = toBunkerURL;
  window.createAccount = createAccount;
  window.fetchBunkerProviders = fetchBunkerProviders;
})();
